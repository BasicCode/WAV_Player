...
# 178 "./mcc_generated_files/system/../system/pins.h"
...
# 60 "./mcc_generated_files/system/../spi/spi1.h"
typedef enum
{
    HOST_CONFIG,
    SPI1_DEFAULT
...
# 90 "./mcc_generated_files/system/../spi/spi1.h"
...
# 107 "./mcc_generated_files/system/../spi/spi1.h"
void SPI1_BufferExchange(void * bufferData, size_t bufferSize);
# 116 "./mcc_generated_files/system/../spi/spi1.h"
void SPI1_BufferWrite(void * bufferData, size_t bufferSize);
# 125 "./mcc_generated_files/system/../spi/spi1.h"
...
# 158 "./mcc_generated_files/system/../spi/spi1.h"
...
# 46 "main.c"
    ...
    w25qxx_FastRead(currentMemoryBlockAddress, dataBuffer, 256);


    WAV_Header file1 = wav_getHeader(dataBuffer, 256, currentMemoryBlockAddress);
    ...
    while(1)
    {
        ...
        while(currentMemoryAddress < file1.FileSize - file1.HeaderSize + file1.DataBeginsAt - 0x200) {
            ...
            _delay((unsigned long)((40)*(64000000U/4000000.0)));
        }
